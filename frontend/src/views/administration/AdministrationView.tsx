  ...
  return (
    <div className="ad-config">
      ...
      <p className="ad-confighelp">
        ...
        restating the key facts. Each option below upgrades that final step to a
        required Worker badge scan in Areas with scanned Worker Sessions — the
        badge records the confirming Worker and completes the action. Areas with
        a fixed or disabled Worker always keep the question; no badge exists
        there.
      </p>
