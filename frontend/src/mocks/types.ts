// Development-only mock data types (Phase 2).
//
// Everything in src/mocks/ is presentation sample data for the approved
// GUI views. It encodes NO production business rules, is never written
// to the backend or PostgreSQL, and is replaced by real read models in
// later phases. Components receive this data via props from their view.
