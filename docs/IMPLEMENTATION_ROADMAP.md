...
- Approved target UI: `GUI_DESIGN.md` v13, with mockup v13 (`docs/mockups/partflow-gui-mockup-v13.html`) as its visual reference.
...
- Machines (per Area, active/maintenance status)
