...
- **§32.1** (return from stock to active production) may later widen the movement-type enum — additive. (`SCRAPPED` is already canonical, PROJECT_PROFILE v9 §8.11, and arrived with Phase 9.)
